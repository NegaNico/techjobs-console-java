...
public class JobData {
    ...
    public static ArrayList<HashMap<String, String>> findByValue(String aValue) {
        ...
        ArrayList<HashMap<String, String>> work = new ArrayList<>();

        for (HashMap<String, String> row : allJobs) {
            for (Map.Entry<String, String> job : row.entrySet()) {
                String hmvalue = job.getValue();

                String mapValue = hmvalue.toLowerCase();
                String searchTerm = aValue.toLowerCase();

                if (mapValue.contains(searchTerm) && !work.contains(row)) {
                    work.add(row);
                }
            }
        }
